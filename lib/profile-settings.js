import { DEFAULT_ANTI_DETECT, settings$ } from '@/states/settings';
export const resolveActiveProfile = (profileId) => {
...
export const resolveProfileUserAgent = (profileId) => {
...
export const getUserAgentForProfile = (profileId) => resolveProfileUserAgent(profileId);
export const resolveProfileSpoofedOS = (profileId) => {
    const profile = resolveActiveProfile(profileId);
    return profile?.spoofedOS ?? DEFAULT_ANTI_DETECT.spoofedOS;
};
export const resolveProfileProxy = (profileId) => {
    const profile = resolveActiveProfile(profileId);
...
export const getEffectiveProxy = (profileId) => resolveProfileProxy(profileId);
export const resolveProfileTimezoneSync = (profileId) => {
    const profile = resolveActiveProfile(profileId);
    return !!(profile?.syncTimezone ?? DEFAULT_ANTI_DETECT.syncTimezone);
};
export const shouldSyncTimezone = (profileId) => resolveProfileTimezoneSync(profileId);
export const getProfileTimezoneOffsetMinutes = (profileId) => {
...
export const buildTimezoneSpoofScript = (profileId) => {
...
export const resolveProfileAntiDetectState = (profileId) => ({
